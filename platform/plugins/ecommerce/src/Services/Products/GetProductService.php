...
class GetProductService
{
    ...
    public function getProduct(
        ...
        // Brand is now removed from the system, so we ignore it
        $brand = null;
        
        $perPage = (int)$request->input('per_page') ? (int)$request->input('per_page') : (int)theme_option('number_of_products_per_page',
            12);
